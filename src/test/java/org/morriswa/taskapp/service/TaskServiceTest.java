...
//    private final PlannerRepo plannerRepo = Mockito.mock(PlannerRepo.class);
//    private final TaskRepo taskRepo = Mockito.mock(TaskRepo.class);
//    @Autowired
//    public TaskServiceTest() {
//        this.test = new TaskService(profileRepo,plannerRepo,taskRepo);
//    }
//
//    @Test
...
//
//        UserProfile updatedUserProfile = test.profileUpdate(testUser,testRequest);
...
//        when(profileRepo.findByUser(testUser)).thenReturn(Optional.of(new UserProfile()));
//
//        Set<Planner> planner = test.plannerAdd(testUser,testRequest);
//        assertEquals(Boolean.TRUE, planner.containsKey(
//                "My Junit Planner"));
...
//        testRequest.put("start-month","0");
//        testRequest.put("start-day","31");
...
//
//        UserProfile updatedUserProfile = test.taskAdd(testUser,testRequest);
//        assertEquals("My Testing Task",
//                updatedUserProfile.getPlanners().get("My Junit Planner").getTasks().get(0).getTitle());
//        assertEquals(START_DATE.get(Calendar.DAY_OF_WEEK),
//                updatedUserProfile.getPlanners().get("My Junit Planner").getTasks().get(0).getStartDate().get(Calendar.DAY_OF_WEEK));
//    }
//
//    @Test
//    void taskSortTest() {
...
//        when(profileRepo.findByUser(testUser)).thenReturn(Optional.of(testUserProfile));
//
//        UserProfile updatedUserProfile = test.oldUpdateTaskStatus(testUser,testRequest);
